...
the search space finite.  Table~\ref{tab:nmconstrain} shows all of the
...
\begin{table}
    ...
    on the search space can be seen in table~\ref{tab:nmconstrain}.}
    \label{tab:paropt}
    {\footnotesize
    \begin{tabularx}{\textwidth}{X|X|X|X|X|}
...
constraints described in table~\ref{tab:nmconstrain}. 
...
These values are plotted per each carbon in the lipid chain in figure~\ref{fig:op:ch1}.
\begin{figure}[H]
...
can be seen in figure~\ref{fig:ch1}.
\begin{figure}[H]
